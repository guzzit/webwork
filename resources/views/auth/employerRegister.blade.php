    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" class="md-form" action="{{ route('employerRegister') }}" enctype='multipart/form-data'>
                        @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="address" class="col-md-4 col-form-label text-md-right">{{ __('Address') }}</label>
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('city') }}" required autocomplete="address" autofocus>
