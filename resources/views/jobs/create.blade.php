...
@section('content')
    <h1>Post Vacancy</h1>
    {!! Form::open(['action' => 'JobsController@store', 'method' => 'POST', 'onsubmit' => 'return five_tag_check(); return false']) !!}
    ...
    <div class='form-group'> 
        ...
        <div class='form-group'> 
                ...
                {{Form::textarea('short_description','', ['class'=>'form-control', 'placeholder'=>'briefly describe the job'])}}
            </div>
        
            <div class='form-group'> 
                {{Form::label('role','Role')}}
                {{Form::textarea('role','', ['class'=>'form-control', 'placeholder'=>'briefly elucidate the role involed'])}}
            </div>

            <div class='form-group'> 
                {{Form::label('skills_requirements','Skills/Requirements')}}
                {{Form::textarea('skills_requirements','', ['class'=>'form-control', 'placeholder'=>'briefly elucidate the skills and requirements necessary'])}}
            </div>
